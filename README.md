...
# Gzadm Navigator - 智能高效招生咨询与知识库管理平台

> **Gzadm Navigator** 是一款专为高校及招生机构打造的高效、智能、数据驱动的 AI 入学咨询服务与知识库管理系统。

---

## 目录

- [🏫 面向学校与招生机构（使用者指南）](#-面向学校与招生机构使用者指南)
  - [核心业务功能与亮点](#核心业务功能与亮点)
  - [控制台三大管理维度](#控制台三大管理维度)
...
1. **24/7 智能招生咨询顾问 (Dr. Elena)**

   - 实时结合高校官方权威知识库解答考生及家长的**招生政策、录取分数线、专业特色、学费奖学金、宿舍环境、保研转专业**等各类热点问题。
   - **广州大学大学城校区地图导览**：以番禺区大学城校区为范围，提供图书馆、教学楼群、梅兰菊竹苑、各饭堂、中心体育场、何世杰体育馆、校医院与交通接驳点等地标及相关配图，支持考生一键针对特定场所发起咨询。
2. **考生高考背景资料精准匹配**

   - 考生可填写真实的高考分数、全省排名位次、选科科目（如物化生、史地政）及特殊加分/体检情况。
   - 系统结合省份政策与历史录取位次，自动为考生提供阶梯式填报建议与专业匹配评估。
