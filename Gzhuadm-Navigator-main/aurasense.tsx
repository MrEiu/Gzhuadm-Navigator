...
const DEFAULT_CAMPUS_LOCATIONS = [
  {
    ...
    description: '大学城校区的公共学习与信息资源中心，提供纸质图书、电子数据库、阅览座位和研讨空间。具体开放楼层与时间以图书馆当天公告为准。',
    terms: ['借阅服务', '电子资源', '研讨室', '考研自习', '静音阅读室', 'Wi-Fi'],
    coordinates: { x: 61, y: 40 },
    highlights: ['纸质与电子馆藏', '研讨室预约', '考研自习专区', '静音阅读空间'],
    openingHours: '开放时间随学期与节假日调整，请以图书馆公告为准'
  },
  {
    id: 'loc-002',
    shortName: '行政楼',
    ...
    description: '大学城校区集中办理校务、证明、信息咨询等事务的行政服务区域。办理前建议先查看学校门户或相关部门通知，确认材料和办公时间。',
    terms: ['校务办理', '证明开具', '信息咨询', '招生咨询', '校园卡服务'],
    coordinates: { x: 51, y: 16 },
    highlights: ['校务窗口集中', '办事材料咨询', '校园事务指引'],
    openingHours: '工作日办公，具体窗口时间以学校公告为准'
  },
  {
    id: 'loc-003',
    shortName: '教学楼群',
    ...
    description: '大学城校区主要公共课与文科课程的上课区域，周边连接图书馆、行政服务区和生活区。上课前可通过课表确认具体楼栋、教室和校区。',
    terms: ['公共课教室', '智慧教室', '课程教室', '教学楼', '自习座位'],
    coordinates: { x: 37, y: 46 },
    highlights: ['公共课集中', '智慧教学空间', '步行连接图书馆'],
    openingHours: '以课程安排和教学楼开放通知为准'
  },
  {
    id: 'loc-004',
    shortName: '实验中心',
    ...
    description: '面向理工科课程、实验教学和学生实践的教学区域。实验室通常需要按学院要求预约或凭证进入，具体规则以任课教师和学院通知为准。',
    terms: ['实验课', '实验室预约', '工程实践', '理工科教学', '安全规范'],
    coordinates: { x: 61, y: 48 },
    highlights: ['实验教学空间', '工程实践课程', '学院实验室管理'],
    openingHours: '以学院实验室预约和安全管理规定为准'
  },
  {
    id: 'loc-005',
    shortName: '中心体育场',
    ...
    description: '大学城校区户外运动和大型校园活动的重要场地，设有标准田径跑道、足球场及周边运动设施。大型活动或恶劣天气期间可能临时管控。',
    terms: ['田径跑道', '足球场', '校运会', '户外跑步', '体育课', '运动场预约'],
    coordinates: { x: 51, y: 79 },
    highlights: ['标准田径跑道', '真草坪足球场', '校运会活动场地', '户外运动区'],
    openingHours: '以体育场馆当天开放安排为准'
  },
  {
    id: 'loc-006',
    shortName: '何世杰体育馆',
    ...
    description: '承办篮球、羽毛球、乒乓球等室内体育活动和大型集会的场馆。热门时段通常需要通过学校体育场馆预约系统提前预约。',
    terms: ['篮球馆', '羽毛球馆', '乒乓球馆', '场馆预约', '体育活动', '大型集会'],
    coordinates: { x: 49, y: 43 },
    highlights: ['室内综合场馆', '篮球与羽毛球活动', '体育场馆预约'],
    openingHours: '以体育场馆预约系统显示时间为准'
  },
  {
    id: 'loc-007',
    shortName: '梅苑一饭',
    ...
    description: '梅苑生活区的主要就餐点，靠近宿舍区与运动场馆。饭点人流较大，具体窗口和营业时间以餐厅现场公告为准。',
    terms: ['一饭', '快餐', '原味汤粉', '麻辣香锅', '梅苑生活区', '错峰用餐'],
    coordinates: { x: 27, y: 71 },
    highlights: ['靠近梅苑宿舍区', '距离运动场馆较近', '餐饮选择丰富'],
    openingHours: '餐厅营业时间以现场公告为准'
  },
  {
    id: 'loc-008',
    shortName: '兰苑二饭',
    ...
    description: '兰苑生活区的主要就餐点，周边有商业服务和宿舍公共设施，轻食、甜点和清淡口味选择较多。',
    terms: ['二饭', '轻食', '甜点', '兰苑生活区', '空调座位', '错峰用餐'],
    coordinates: { x: 78, y: 32 },
    highlights: ['靠近兰苑宿舍区', '生活商业配套', '清淡餐饮选择较多'],
    openingHours: '餐厅营业时间以现场公告为准'
  },
  {
    id: 'loc-009',
    ...
    description: '菊苑餐厅（三饭）靠近教学区与商业中心，是下课后就餐较方便的生活节点。饭点人流较大，建议错峰用餐。',
    terms: ['三饭', '快餐', '面食', '烧腊', '教学区就餐', '错峰用餐'],
    coordinates: { x: 35, y: 26 },
    highlights: ['靠近教学区', '快餐与面食选择多', '步行就餐方便'],
    openingHours: '餐厅营业时间以现场公告为准，饭点建议错峰'
  },
  {
    id: 'loc-010',
    shortName: '竹苑 / 四饭',
    ...
    description: '竹苑生活区靠近商业街和竹苑餐厅（四饭），适合用餐、购买日用品和晚间休闲。宿舍和商业点位会按校方规划动态调整。',
    terms: ['四饭', '商业街', '夜宵', '宿舍生活', '日用品', '快递点'],
    coordinates: { x: 83, y: 78 },
    highlights: ['靠近商业街', '竹苑餐厅（四饭）', '夜间生活配套丰富'],
    openingHours: '餐厅与商业街时间以现场公告为准'
  },
  {
    id: 'loc-011',
    shortName: '校医院',
    ...
    description: '为师生提供基础门诊、常见病处理和健康咨询。遇到急重症应及时拨打急救电话，并按校医院指引前往校外医院就诊。',
    terms: ['门诊', '医保', '健康咨询', '急救', '转诊', '校园卡'],
    coordinates: { x: 38, y: 29 },
    highlights: ['基础门诊服务', '医保就诊指引', '校内健康咨询'],
    openingHours: '门诊与急诊安排以校医院当天公告为准'
  },
  {
    id: 'loc-012',
    shortName: '校门 / 接驳',
    ...
    category: '交通出行',
    images: [
      'https://images.unsplash.com/photo-1518005020951-e791660c2ca9?q=80&w=800&auto=format&fit=crop',
      'https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?q=80&w=800&auto=format&fit=crop'
    ],
    description: '广州大学大学城校区位于番禺区广州大学城外环西路230号。校内步行和骑行是主要通勤方式，出行前请核对校门开放、公交和地铁接驳安排。',
    terms: ['外环西路230号', '大学城', '公交接驳', '地铁', '校门通行', '骑行'],
    coordinates: { x: 50, y: 94 },
    highlights: ['番禺区大学城校区', '外环西路230号', '公共交通接驳', '校内步行通勤'],
    openingHours: '校门通行和接驳时刻以保卫处、公交及地铁公告为准'
  },
  {
    id: 'loc-013',
    shortName: '梅苑宿舍',
    ...
    description: '位于校园生活区西南侧，靠近梅苑餐厅（一饭）和户外运动场馆。大学城校区宿舍房型按学院和后勤安排分配，具体楼栋以报到通知为准。',
    terms: ['梅苑', '4人间', '6人间', '独立卫浴', '空调', '共享洗衣'],
    coordinates: { x: 21, y: 62 },
    highlights: ['靠近一饭', '靠近体育场馆', '生活服务集中'],
    openingHours: '宿舍门禁和公共服务时间以校方公告为准'
  },
  {
    id: 'loc-014',
    shortName: '兰苑宿舍',
    ...
    description: '位于校园东侧生活区，靠近兰苑餐厅（二饭）和商业服务点。宿舍分配、门禁与维修服务由学校后勤统一管理。',
    terms: ['兰苑', '宿舍分配', '4人间', '6人间', '二饭', '生活服务'],
    coordinates: { x: 73, y: 24 },
    highlights: ['靠近二饭', '商业配套便利', '生活区绿化较集中'],
    openingHours: '宿舍门禁和公共服务时间以校方公告为准'
  },
  {
    id: 'loc-015',
    ...
    description: '靠近教学区与菊苑餐厅（三饭）的生活片区，通勤和就餐较方便。具体宿舍楼及房型以学院分配结果为准。',
    terms: ['菊苑', '宿舍生活', '三饭', '教学区通勤', '空调', '独立卫浴'],
    coordinates: { x: 29, y: 29 },
    highlights: ['靠近教学区', '靠近三饭', '步行通勤方便'],
    openingHours: '宿舍门禁和公共服务时间以校方公告为准'
  },
  {
    id: 'loc-016',
    ...
    description: '位于校园东南侧生活区，靠近竹苑餐厅（四饭）和商业街，日用品、快递和夜间餐饮服务较集中。',
    terms: ['竹苑', '宿舍生活', '四饭', '商业街', '快递点', '夜宵'],
    coordinates: { x: 87, y: 69 },
    highlights: ['靠近四饭', '商业街配套', '夜间生活便利'],
    openingHours: '宿舍门禁和商业服务时间以校方公告为准'
  },
  {
    id: 'loc-017',
    shortName: '公共教学楼',
    ...
    description: '校园中部教学区的公共教学楼，承担公共课、基础课和部分专业课程。请按课表确认具体楼栋、教室和上课时间。',
    terms: ['公共课', '教学楼 A 区', '智慧教室', '课程教室', '上课地点'],
    coordinates: { x: 42, y: 50 },
    highlights: ['位于教学区中部', '公共课教室集中', '连接图书馆与生活区'],
    openingHours: '以课程安排和教学楼开放通知为准'
  },
  {
    id: 'loc-018',
    ...
    description: '校园中部偏东的理工科教学区域，服务数学、计算机、工程等课程教学。实验课程请遵守学院实验室预约和安全要求。',
    terms: ['理工科课程', '计算机课程', '工程实践', '教学楼 B 区', '实验课'],
    coordinates: { x: 56, y: 53 },
    highlights: ['靠近理工教学区', '工程实践课程', '连接实验中心'],
    openingHours: '以课程安排和学院通知为准'
  },
  {
    id: 'loc-019',
    shortName: '实验教学楼',
    ...
    description: '位于理工教学区附近的实验与实践空间，面向课程实验、工程训练和学生创新实践。进入实验室需遵守学院安全管理规定。',
    terms: ['实验教学', '工程实践', '实验室预约', '创新实践', '安全规范'],
    coordinates: { x: 66, y: 47 },
    highlights: ['靠近理工教学楼', '课程实验空间', '工程实践与创新训练'],
    openingHours: '以实验室预约和学院通知为准'
  },
  {
    id: 'loc-020',
    shortName: '北门',
    ...
    description: '位于校园北侧的主要出入口之一，迎新、访客和公共交通接驳请按当日校门管理与保卫处通知通行。',
    terms: ['北门', '迎新接驳', '访客通行', '公交', '校门管理'],
    coordinates: { x: 29, y: 8 },
    highlights: ['校园北侧出入口', '迎新接驳关注点', '访客通行指引'],
    openingHours: '校门开放和接驳安排以保卫处、公交公告为准'
  }
];
...
const MapGuideModal = ({ locations, isOpen, onClose, onAskQuestion }) => {
  ...
  const categories = ['全部', ...Array.from(new Set(locations.map((loc) => loc.category)))];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                    <h3 className="text-[17px] font-black text-[#4a4365]">广州大学大学城校区地图导览</h3>
              ...
              <p className="text-[12px] text-[#7a7398]">番禺区大学城校区 · 外环西路230号 · 查看校内地标与生活服务</p>
            </div>
          </div>
          ...
          {viewMode === 'map' ? (
            /* Map View */
             <div className="w-full h-full min-h-[480px] bg-gradient-to-br from-[#f0ebfb] via-[#f7f4fd] to-[#eaf2fb] rounded-3xl border-2 border-white shadow-inner relative overflow-hidden flex flex-col justify-between p-4 group">
               ...
               <div className="absolute inset-8 rounded-[28px] border border-[#a494e8]/25 pointer-events-none" />
               <div className="absolute left-[12%] right-[12%] top-[47%] h-3 rounded-full bg-white/75 border border-[#c9c0e7]/70 rotate-[-5deg] pointer-events-none" />
               <div className="absolute top-[13%] bottom-[17%] left-[49%] w-3 rounded-full bg-white/70 border border-[#c9c0e7]/60 rotate-[8deg] pointer-events-none" />
               <div className="absolute left-[14%] right-[17%] bottom-[10%] h-7 rounded-full border-y border-[#bdb2df]/70 pointer-events-none" />
               <div className="absolute top-5 right-6 text-center text-[#6c5aa8] z-10 pointer-events-none">
                 <div className="text-[15px] font-black leading-none">N</div>
                 <div className="text-[14px] leading-none">↑</div>
                 <div className="text-[9px] font-bold mt-0.5">北</div>
               </div>
               <div className="absolute bottom-5 left-7 text-[10px] font-bold text-[#7a7398] bg-white/65 px-2.5 py-1 rounded-lg border border-white/80 pointer-events-none">
                 外环西路 · 校区南侧
               </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-2xl shadow-lg border transition-all duration-300 ${
                        ...
                        <span className="text-[12px] font-bold whitespace-nowrap">{loc.shortName || loc.name}</span>
                      </div>
              ...
              {/* Map Footer Prompt */}
               <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-2xl shadow-md border border-white text-[11px] text-gray-500 flex items-center gap-2 z-10">
                 ...
                 <span>点击标点查看地标与相关配图；点位为校区导览示意，实际路线以现场导视为准</span>
               </div>
            </div>
          ) : (
            /* Grid View */
        ...
        aggregatedDialogues = [
          {
            ...
            reply: '同学习好！根据往年录取数据，计算机科学与技术专业在浙江省位次大约在全省 12000-15000 名左右（对应分数为 635-645 分）。大学城校区宿舍以 4 人间、6 人间为主，通常配备独立卫浴与空调，具体以当年分配为准。',
          ...
          },
          {
            ...
            question: '大学城校区宿舍条件怎么样？有独立洗手间和热水吗？离图书馆远不远？',
            reply: '同学您好！大学城校区宿舍主要分为 4 人间和 6 人间，通常配备空调、独立卫浴和阳台；不同苑区到图书馆的步行时间不同，建议按学院分配的具体宿舍楼查看路线。',
